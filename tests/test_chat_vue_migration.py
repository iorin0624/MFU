...
class ChatVueMigrationSourceTests(unittest.TestCase):
    ...
    def test_mfu_chat_scope_uses_the_vue_screen_without_becoming_a_participant_session(self):
        ...
        main = (ROOT / "external_login_user/frontend/src/main.ts").read_text(encoding="utf-8-sig")
        ...
        self.assertIn('watch(requestedMfuChat', app)
        self.assertIn('router.isReady().then', main)
